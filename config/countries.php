...
|--------------------------------------------------------------------------
|
| Every country the checkout will accept, keyed by ISO 3166-1 alpha-2 with a
| display name and an international dialling code. Two selects read this list:
| the delivery country and the phone's country code. Lebanon is the default —
| it is `store.contact.country` / `store.contact.country_code` that decides
| that, not the order of this array.
|
*/
...
return [
    ...
    'KY' => ['name' => 'Cayman Islands', 'dial' => '1345'],
    ...
    'ST' => ['name' => 'São Tomé and Príncipe', 'dial' => '239'],
    ...
    'KN' => ['name' => 'St Kitts and Nevis', 'dial' => '1869'],
    'LC' => ['name' => 'St Lucia', 'dial' => '1758'],
    'VC' => ['name' => 'St Vincent and the Grenadines', 'dial' => '1784'],
